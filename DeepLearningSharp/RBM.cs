...
namespace DeepLearningSharp
{
    public class RBM
    {
                   ...
                   double[][] W, double[] hbias, double[] vbias, Random rng)
        {
            ...
            if (W == null)
            {
                this.W = utils.CreateCrossArray<double>(this.n_hidden, this.n_visible); //new double[this.n_hidden,this.n_visible];
        ...
        private static void test_rbm()
        {
            ...
            double[][] reconstructed_X = utils.CreateCrossArray<double>(test_N, n_visible);// new double[test_N,n_visible];
